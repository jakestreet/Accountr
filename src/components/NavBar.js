...
export default function NavBar() {
  ...
  const [journalNav, setJournalNav] = useState("");
  ...
  function RenderNav() {
    ...
    if (
      location.pathname === "/event-log" &&
      eventLogNav !== "nav-link active"
    ) {
      setHomeNav("nav-link");
      setUsersNav("nav-link");
    ...
    if (location.pathname === "/journal" && journalNav !== "nav-link active") {
      setHomeNav("nav-link");
      setUsersNav("nav-link");
      setEventLogNav("nav-link");
      setProfileNav("nav-link");
      setAccountsNav("nav-link");
      setJournalNav("nav-link active");
    }
    ...
    if (
      ...
      location.pathname !== "/answer-questions"
    ) {
      GetRole();
      return (
          ...
          >
            <div className="gap-2 d-flex" style={{ flexGrow: 1, flexBasis: 0 }}>
              ...
              <MDBTooltip tag="a" placement="auto" title="View calendar">
                <Button
                  ...
                  aria-describedby={id}
                  variant="contained"
                  style={{ backgroundColor: "rgba(41,121,255,1)" }}
                  onClick={handleClick}
                  className="me-2 mt-1"
                >
                  <CalendarMonthIcon />
            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                {/* eslint-disable-next-line*/}
                <a
                  className={accountsNav}
                  onClick={AccountsNavigate}
                  href=""
                  aria-current="page"
                  style={{ fontSize: 20 }}
                >
              ...
              <li className="nav-item">
                {/* eslint-disable-next-line*/}
                <a
                  className={journalNav}
                  onClick={JournalNavigate}
                  href=""
                  aria-current="page"
                  style={{ fontSize: 20 }}
                >
      ...
      if (currentRole === "Admin") {
        return (
          <li className="nav-item">
            {/* eslint-disable-next-line*/}
            <a
              className={eventLogNav}
              onClick={EventLogNavigate}
              href=""
              style={{ fontSize: 20 }}
            >
              Event Log
